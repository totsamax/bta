            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/taxiAdmin/">Принятые заказы</a></li>
                        <li><a href="newOrders.php">Необработанные заказы</a></li>
                    ...
                    <!--                    <div class="col-lg-4">
                                            <form class="form-group-sm">
                                                <div class="form-group">
                                                    <label class="sr-only" for="exampleInputAmount">Сумма</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon">СОМ</div>
                                                        <input type="text" class="form-control" id="exampleInputAmount" placeholder="Сумма">
                                                    </div>
                                                    <label class="sr-only" for="select">Сумма</label>
                                                    <select class="form-control" id="select">
                                                        <option>Максим Ухов</option>
                                                        <option>Максим Ухов</option>
                                                        <option>Максим Ухов</option>
                                                        <option>Максим Ухов</option>
                                                        <option>Максим Ухов</option>
